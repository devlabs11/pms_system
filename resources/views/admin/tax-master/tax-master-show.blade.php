        ...
        label.error {
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                                                            <div class="menu-item">
                                    <a class="menu-link" href="http://erp-test.devharshinfotech.com/tax-master">
                                        <span class="menu-bullet">
                                            <span class="bullet bullet-dot"></span>
                                        </span>
												...
												<div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
													...
													<div class="d-flex flex-column px-9">
														...
														<div class="text-center px-4">
															<img class="mw-100 mh-200px" alt="image" src="http://erp-test.devharshinfotech.com/assets/media/illustrations/sketchy-1/1.png " />
														</div>
														<!--end::Illustration-->
													</div>
													<!--end::Wrapper-->
						...
						@foreach($showGst as $key=>$data)
                                  <tr>
                                    ...
                                    <a href="/edit-tax-master/{{$data->id}}" title="Edit" class="menu-link flex-stack px-3" style="font-weight:normal !important;"><i class="fa fa-edit" style="font-weight:normal !important;"></i></a>
                                     <a  onclick="return confirm('Are you sure?')"  href="/delete-tax-master/{{$data->id}}" title="Delete" style="cursor: pointer;font-weight:normal !important;" class="menu-link flex-stack px-3"><i class="fa fa-trash" style="color:red;"> </i></a>
                                       </td>
                                   </tr>
								   @endforeach
                                              </tbody>
